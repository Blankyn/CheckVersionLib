...
import com.blankm.sample.R;
import me.blankm.versionchecklib.core.VersionDialogActivity;
import me.blankm.versionchecklib.callback.APKDownloadListener;
import me.blankm.versionchecklib.callback.DialogDismissListener;
...
//                });
            ...
            ProgressBar pb = (ProgressBar) loadingView.findViewById(me.blankm.versionchecklib.R.id.pb);
            TextView tvProgress = (TextView) loadingView.findViewById(me.blankm.versionchecklib.R.id.tv_progress);
            tvProgress.setText(String.format(getString(me.blankm.versionchecklib.R.string.versionchecklib_progress), currentProgress));
