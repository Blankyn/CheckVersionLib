...
public class UIData {
    private final String TITLE = "title", CONTENT = "content", DOWNLOAD_URL = "download_url", REFERER = "referer";
    ...
    public String getReferer() {
        return versionBundle.getString(REFERER);
    }

    public UIData setReferer(String referer) {
        versionBundle.putString(REFERER, referer);
        return this;
    }
